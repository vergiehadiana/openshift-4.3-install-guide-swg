...
# replace 192.168.100.110 with IP of your load balancer/webserver node
ssh root@192.168.100.110 mkdir -p /var/www/html/ignition/
ssh root@192.168.100.110 rm /var/www/html/ignition/bootstrap.ign
scp bootstrap.ign  root@192.168.100.110:/var/www/html/ignition/
ssh root@192.168.100.110 chmod 777 /var/www/html/ignition/bootstrap.ign
